...
| C.5.8 | claim | `claim:pairing-copairing` | `combinators.tex` |
| C.5.9 | claim | `claim:finite-type-bijection-disjoint-units` | `combinators.tex` |
| C.5.10 | claim | `claim:finite-domain-regular-list-function` | `combinators.tex` |
| C.5.11 | lemma | `lem:terms-define-append-hash` | `combinators.tex` |
| C.5.12 | claim | `claim:bang-definable` | `combinators.tex` |
| C.5.13 | lemma | `lem:terms-define-map-reverse-duplicate` | `combinators.tex` |
| C.5.14 | lemma | `lem:terms-define-flip-flop` | `combinators.tex` |
