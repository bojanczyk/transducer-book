...
CHAPTERS = [
    ...
    ("02-mealy-machines-introduction", "partAMealy/intro.tex", 1, 0),
    ("03-mealy-machines", "partAMealy/mealy.tex", 1, 0),
    ("04-krohn-rhodes", "partAMealy/krohn-rhodes.tex", 1, 1),
    ("04z-mealy-machines-references", "partAMealy/bib-notes.tex", 1, 2),
    ("05-rational-functions-introduction", "partBRational/intro.tex", 2, 0),
    ("06-rational-relations", "partBRational/rational-relations.tex", 2, 0),
    ("07-rational-functions", "partBRational/rational-functions.tex", 2, 1),
    ("08-weighted-automata", "partBRational/weighted.tex", 2, 2),
    ("09-machine-independent", "partBRational/myhill-nerode.tex", 2, 3),
    ("09z-rational-functions-references", "partBRational/bib-notes.tex", 2, 4),
    ("10-regular-functions-introduction", "partCRegular/intro.tex", 3, 0),
    ("11-prime-regular-functions", "partCRegular/regular-primes.tex", 3, 0),
    ("12-two-way-transducers", "partCRegular/2dfa.tex", 3, 1),
    ("13-streaming-string-transducers", "partCRegular/sst.tex", 3, 2),
    ("14-logic", "partCRegular/logic.tex", 3, 3),
    ("14a-combinators", "partCRegular/combinators.tex", 3, 4),
    ("14z-regular-functions-references", "partCRegular/bib-notes.tex", 3, 5),
    ("15-polyregular-functions-introduction", "partDPolyregular/intro.tex", 4, 0),
    ("16-for-transducers", "partDPolyregular/for.tex", 4, 0),
    ("17-pebble-transducers", "partDPolyregular/pebble.tex", 4, 1),
    ("17z-polyregular-functions-references", "partDPolyregular/bib-notes.tex", 4, 2),
]
