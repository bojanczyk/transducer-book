% source stamp shared:7cb419a6 — maintained by build-source-stamps.py; it is what makes editing ../macros.sty, ../transducer-macros.sty or the pictures recompile every block
