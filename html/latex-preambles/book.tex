% source stamp shared:93cac303 — maintained by build-source-stamps.py; it is what makes editing ../macros.sty, the pictures or the book's numbering recompile every block
