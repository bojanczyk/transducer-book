...
\begin{myexample}[Parity under string representation]
    ...
    \begin{center}
        todo
    \end{center}
    \issue{The automaton is missing --- there is a ``todo'' placeholder above.}Therefore, we could improve $f'$ so that it produces the empty string for inputs that are not correctly formatted.
\end{myexample}
