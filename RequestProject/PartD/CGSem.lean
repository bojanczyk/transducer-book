...
-/
import RequestProject.PartD.CGAtom
...
lemma mem_reachL_iff (M : Pebble A B Q k) {ell : ℕ} {nid : Fin k} {q₁ q₂ : Q} {sp₁ sp₂ : Spot}
  ...
  rw [reachL, Set.mem_setOf_eq, pairMap_confEnc hnid q₁ q₂ hx h₁ h₂]
...
lemma mem_stepL_iff (M : Pebble A B Q k) {nid : Fin k} {q₁ q₂ : Q} {sp₁ sp₂ : Spot}
  ...
  rw [stepL, Set.mem_setOf_eq, pairMap_confEnc hnid (q₁, false) (q₂, true) hx h₁ h₂]
