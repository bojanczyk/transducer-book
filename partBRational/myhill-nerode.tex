...
\exer{\label{exer:duplication-not-rational} Show that string duplication is not rational.}{
    Similarly to string reversal, the relation $\sim$ from Theorem~\ref{thm:machine-independent-rational-functions} has infinite index for the duplication function; in fact all strings are pairwise non-equivalent.
}
